(function ($) {
    ...
    $('.faq_list').owlCarousel({
        ...
        dots: false,
        nav: true,
        navText: ["<i class='bi bi-arrow-left''></i> Previous", "Next <i class='bi bi-arrow-right''></i> "],
        responsive: {
            0: {
                items: 1
            },
...
document.getElementById("easy-price").textContent = "$39";
    document.getElementById("basic-price").textContent = "$19";
    document.getElementById("hard-price").textContent = "$29";
    document.getElementById("monthly-btn").classList.add("active");
    document.getElementById("yearly-btn").classList.remove("active");
}

function showYearly() {
    document.getElementById("easy-price").textContent = "$390";
    document.getElementById("basic-price").textContent = "$190";
    document.getElementById("hard-price").textContent = "$290";
